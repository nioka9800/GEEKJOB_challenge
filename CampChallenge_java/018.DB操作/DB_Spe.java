 ...
 * @author guest1Day
 */
@WebServlet(urlPatterns = {"/DB_Spe"})
public class DB_Spe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try{
                ...
                db_ps = db_c.prepareStatement("select profilesID, name, tel, age, birthday from profiles where name like \'%茂%\'");
